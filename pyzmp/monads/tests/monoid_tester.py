...
from pyzmp.monads.monoid import Monoid, mzero, mconcat


class MonoidTester(unittest.TestCase):
    def given_monoid(self, m):
        self.monoid = m

    def given_monoids(self, *ms):
        self.monoids = ms
    ...
    def ensure_mzero_is(self, value):
        self.assertEqual(self.mzero, value)
